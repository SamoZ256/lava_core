...
public:
    ...
    static void transitionImageLayout(uint8_t threadIndex, VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, VkImageAspectFlags aspectMask = VK_IMAGE_ASPECT_COLOR_BIT, uint8_t layerCount = 1, uint8_t mipCount = 1);
